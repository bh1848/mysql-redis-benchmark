...
- 평균 응답 시간 위주의 측정으로, P99 등 Tail Latency에 대한 분석 부족
...
2. 동일한 로직이라도 하드웨어 상태와 초기화 변수에 따라 결과가 달라질 수 있다는 것을 확입했습니다. 이에 따라 Template Method 패턴을 통한 측정 로직 표준화와 환경 격리가 벤치마크 신뢰도에서 중요하다는 것을 확인했습니다.

3. 실제 운영 환경에서는 평균 응답 속도말고 튀는 값도 중요하다는 것을 확인했습니다. 다음엔 P95/P99 Latency도 모니터링할 생각입니다.
